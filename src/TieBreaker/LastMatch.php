...
/**
 * Breaks a tie by returning the match that appeared latest in the haystack.
 */
final class LastMatch implements TieBreakerInterface
{
    /**
     * {@inheritDoc}
     */
    public function __invoke(string $needle, array $tiedResults): MatchResultInterface
    {
        ...
        return $tiedResults[count($tiedResults) - 1];
    }
}
